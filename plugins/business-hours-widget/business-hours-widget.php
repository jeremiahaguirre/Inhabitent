 ...
 *
 * @package   Tent_Bix_Hours
 * @author    Jeremiah Aguirre <happytobike@.com>
 * @license   GPL-2.0+
 ...
 * Plugin URI:        https://github.com/jeremiahaguirre/Inhabitent
 * Description:       A widget that displays business hour for the Inhabitent website
 * Version:           1.0.0
 * Author:            Jeremiah Aguire
 * Author URI:        http://github.com/jeremiahaguirre
 * License:           GPL-2.0+
...
class Tent_Biz_Hours extends WP_Widget {
	...
	public function form( $instance ) {
		...
		//Define default values the variables
